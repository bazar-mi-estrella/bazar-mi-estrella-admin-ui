...
export class BasicComponent implements OnInit {
  ...
  oobCode: string = this.activatedRoute.snapshot.queryParams["oobCode"]
  ...
  initVerify(): void {
    if (!this.oobCode) {
      ...
      this.workerService.verifyPasswordResetCode(this.oobCode)
        .then(x => this.isLoaderInit = false)
        .catch(x => console.log("errorrrrrrrrrr", x))
    }
  }
